def ordenar_por_nombre_y_especie(jedis):
    return sorted(jedis, key=lambda x: (x['name'], x['species']))
    ...
    for nombre in nombres:
        for jedi in jedis:
            if jedi['name'] == nombre:
                ...
                print(f"Maestro: {jedi['master']}")
                print(f"Color de sable de luz: {jedi['lightsaber_color']}")
                print(f"Planeta natal: {jedi['homeworld']}")
                print(f"Año de nacimiento: {jedi['birth_year']}")
                print(f"Altura: {jedi['height']}")
                print(f"Tendencia al Lado Oscuro: {jedi['to_darkside']}")
                print(f"Tendencia al Lado Luminoso: {jedi['come_lightside']}")
                print()
                break
        else:
...
def jedis_que_comienzan_con(jedis, letra):
    return [jedi for jedi in jedis if jedi['name'].startswith(letra)]

def jedis_con_mas_de_un_color(jedis):
    return [jedi for jedi in jedis if jedi['lightsaber_color'] is not None and '/' in jedi['lightsaber_color']]


def jedis_con_color_especifico(jedis, color):
    return [jedi for jedi in jedis if jedi['lightsaber_color'] is not None and color in jedi['lightsaber_color']]


def padawans_de_maestro(jedis, maestro):
    return [jedi['name'] for jedi in jedis if jedi['master'] == maestro and jedi['rank'] == 'Padawan']
...
resultados = ordenar_por_nombre_y_especie(jedis)
print("a) Listado ordenado por nombre y especie:")
for jedi in resultados:
...
yoda_padawans = padawans_de_maestros(jedis, 'Yoda')
luke_padawans = padawans_de_maestros(jedis, 'Luke Skywalker')
print("Padawans de Yoda:", [padawan['name'] for padawan in yoda_padawans])
print("Padawans de Luke Skywalker:", [padawan['name'] for padawan in luke_padawans])

print("\nd) Jedi de especie humana y twi'lek:")
humano_twi_lek = jedis_por_especie(jedis, 'Human', 'Twi\'lek')
for jedi in humano_twi_lek:
    print(jedi['name'], jedi['species'])

print("\ne) Jedi cuyos nombres comienzan con A:")
jedis_con_A = jedis_que_comienzan_con(jedis, 'A')
for jedi in jedis_con_A:
    print(jedi['name'])

print("\nf) Jedi que usaron sable de luz de más de un color:")
jedis_con_mas_colores = jedis_con_mas_de_un_color(jedis)
for jedi in jedis_con_mas_colores:
    print(jedi['name'])

print("\ng) Jedi que utilizaron sable de luz amarillo o violeta:")
jedis_amarillo_violeta = jedis_con_color_especifico(jedis, 'Yellow') + jedis_con_color_especifico(jedis, 'Violet')
for jedi in jedis_amarillo_violeta:
    print(jedi['name'])

print("\nh) Padawans de Qui-Gon Jinn y Mace Windu:")
print("Padawans de Qui-Gon Jinn:", padawans_de_maestro(jedis, 'Qui-Gon Jinn'))
print("Padawans de Mace Windu:", padawans_de_maestro(jedis, 'Mace Windu'))

print("\ni) Jedi con el ranking de Grand Master:")
